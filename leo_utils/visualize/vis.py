...
def combine_two_videos_vertically(video1_path, video2_path, output_path, tag1='', tag2=''):
    cap1 = cv2.VideoCapture(video1_path)
    cap2 = cv2.VideoCapture(video2_path)
...
def main():
    ...
    # combine_two_videos_horizontally(video1_path, video2_path, output_path, tag1='YOLOv8m', tag2='YOLOv11x')
    combine_two_videos_vertically(video1_path, video2_path, output_path, tag1='YOLOv8m', tag2='YOLOv11x')
