...
if __name__ == '__main__':
    ...
    # parser.add_argument('--video', type=str, default="rtsp://admin:Noldus123@169.254.8.255/axis-media/media.amp", help='Video source (0 for webcam or path)')
    parser.add_argument('--use_webcam', type=bool, default=True, help='Use video source (0 for webcam)')
    ...
    parser.add_argument('--mask_path', type=str, default="./mask/789.png", help='Path to room segmentation mask')
